...
conn.send3ButtonImg(m.chat, `${pickRandom(flaaa2)}` + `${ucapan()} ` + `${name}`, nth, rules, 'FF', '.nsfw neko', 'ML', '.nsfw hentai', 'Owner', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
