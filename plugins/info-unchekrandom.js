...
conn.send3ButtonImg(m.chat, `${pickRandom(flaaa2)}` + `${ucapan()} ` + `${name}`, nth, rules, 'GOOGLE', '.soya', 'OWNER COY 😼💪', '.owner', 'FACEBOOK', '.susus', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
