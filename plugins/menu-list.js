...
const sections = [
   {
    ...
    rows: [
        ...
        {title: `🔞 • Nsfw`, rowId: ".? nsfw", description: "Yamate ah >///<"},
        ...
        {title: `📖 • Al-Quran`, rowId: ".? quran", description: "Tobat yuk Bre"},
        ...
        {title: `🎨 • Logo`, rowId: ".? logo", description: "Buat Logo Kamu diBOT"},
        ...
        {title: `🎧 • Sound Kane Menu`, rowId: ".soundkanemenu", description: "Kumpulan 24 Sound"},
...
│
├━━━━━━━━━━━━━━━━┈─⋆
│ ▸ *ᴀᴜᴛʜᴏʀ :* @${nomorown1.split`@`[0]}
┴ ▸ *ᴏᴡɴᴇʀ :* @${nomorown.split`@`[0]}
✧
┬ 📌 𝗣𝗶𝗻𝗻𝗲𝗱 :
│ BERI JEDA BRE ^ω^
│
