...
const sections = [
   {
	title: '◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥◤◢◣◥',
	rows: [
	{title: `${(ch == true ? false : Free Fire) == true ? p : f}` + "A • Ahegao", rowId: ".nsfw ahegao"},
	{title: `${(ch == true ? false : Mobile Legends) == true ? p:f}` + "A • Anal", rowId: ".nsfw anal"},
	{title: `${(ch == true ? false : Pubg) == true ? p:f}` + "A • Ass", rowId: ".nsfw ass"},
	{title: `${(ch == true ? false : Clash of Clans) == true ? p:f}` + "B • BlowJob", rowId: ".nsfw blowjob"},
	{title: `${(ch == true ? false : Super Sus) == true ? p:f}` + "C • Cumsluts", rowId: ".nsfw cums"},
	{title: `${(ch == true ? false : Class of Duty) == true ? p:f}` + "E • Ecchi", rowId: ".nsfw ecchi"},
	{title: `${(ch == true ? false : Roblox) == true ? p:f}` + "E • Ero", rowId: ".nsfw ero"},
  //{title: `${(ch == true ? false : Tiktok) == true ? p:f}` + "E • Ero Feet", rowId: ".nsfw erofeet"},
	{title: `${(ch == true ? false :  Genshin impact)== true ? p:f}` + "E • Ero Girl", rowId: ".nsfw erogirl"},
	{title: `${(ch == true ? false : Stumble guys) == true ? p:f}` + "E • Ero Holo", rowId: ".nsfw holoero"},
  //{title: `${(ch == true ? false : Gr legends) == true ? p:f}` + "E • Ero Kitsune", rowId: ".nsfw erokitsune"},
  //{title: `${(ch == true ? false : Lord mobile) == true ? p:f}` + "E • Ero Neko", rowId: ".nsfw eroneko"},
  //{title: `${(ch == true ? false : Rise of Kingdoms) == true ? p:f}` + "E • Ero Yuri", rowId: ".nsfw eroyuri"},
	{title: `${(ch == true ? false : Garena blockman GO) == true ? p:f}` + "F • Feet", rowId: ".nsfw feet"},
	{title: `${(ch == true ? false : Garena blockman Editor) == true ? p:f}` + "F • Femdom", rowId: ".nsfw femdom"},
	{title: `${(ch == true ? false : Garena bad wars) == true ? p:f}` + "F • Futanari", rowId: ".nsfw futanari"},
  //{title: `${(ch == true ? false : Zooba) == true ? p:f}` + "G • Girl Solo", rowId: ".nsfw girlsolo"},
	{title: `${(ch == true ? false : Ragnarok X) == true ? p:f}` + "H • Hentai", rowId: ".nsfw hentai"},
	{title: `${(ch == true ? false : Hide online) == true ? p:f}` + "H • Holo", rowId: ".nsfw holo"},
	{title: `${(ch == true ? false : Facebook) == true ? p:f}` + "J • Jahy", rowId: ".nsfw jahy"},
  ...
  //{title: `${(ch == true ? false : kuni) == true ? p:f}` + "K • Kuni", rowId: ".nsfw kuni"},
	{title: `${(ch == true ? false : Tiktok) == true ? p:f}` + "L • Loli", rowId: ".nsfw loli"},
